...
function doSearch() {
    ...
    //获取使用部门
    var ID_department = $("#Department_ST").combotree("getValue");
    //获取资产性质
    var IDTYPE_TypeAsset = $("#ATAttr_ST").combobox("getValue");
    //获取供应商
    var ID_supplier = $("#supplier_ST").combogrid("getValue");
    var ID_supplier_TEXT = $("#supplier_ST").combogrid("getText");
    if (ID_supplier_TEXT == null || ID_supplier_TEXT == "")
    {
        ID_supplier = "";
    }
