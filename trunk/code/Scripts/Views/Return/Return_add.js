...
function LoadInitData_datagrid() {
    ...
    $('#' + ID_DATAGRID_TABLE).datagrid({
        ...
        columns: [[
            ...
            //{ field: 'department_loan', title: '归还部门', width: 50 },
            //{ field: 'user_loan', title: '归还人', width: 50 },
...
function saveData(info) {
    ...
    var department_Return = $("#department_Return").combotree("getValue");
    var user_Return = $("#user_Return").combobox("getValue");
